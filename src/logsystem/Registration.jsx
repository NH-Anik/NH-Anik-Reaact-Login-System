...
import login_one from "../assets/animation/registation-one.json";
            ...
            <div className="flex flex-wrap items-center justify-around">
                ...
                <div className="in-form"> 
                    <form className="form" onSubmit={handleSubmit}>
                        <h1 className="text-center text-4xl text-one font-semibold">Registration</h1>
                        <legend >Username </legend>
                        <input onChange={handelUsername} name="username" type="text" placeholder="Enter your username"/>
                        <h6>{usernameError}</h6>
                        ...
                        <div className="relative">
                            ...
                            <input onChange={handelPassword2} name="password2" type={passwordType} placeholder="Enter your password"/>
                            <h6>{password2Error}</h6>
                            <button type="button" onClick={handelShowHide} className="absolute top-11 right-2">
                                {
                                    passwordType=="password" ? <FaEyeSlash/>  : <FaEye/>
                                }
                        ...
                        <div className="flex justify-center py-10">
                           <Button_v1 type="submit">
                            {
                                loading ?
                                <div role="status"  className="flex items-center gap-2"> <span className="text-five">Sign Up</span>
