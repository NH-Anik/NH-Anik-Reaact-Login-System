...
import login_one from "../assets/animation/forgot-one.json";
            ...
            <div className="flex flex-wrap items-center justify-around">
                ...
                <div className="in-form"> 
                    <form className="form" onSubmit={handleSubmit}>
                        <h1 className="text-center text-4xl text-one font-semibold">Forgot Password</h1>
                        <legend >Email </legend>
                        ...
                        <div className="flex justify-center py-10">
                           <Button_v1 type="submit">
                            {
                                loading ?
                                <div role="status"  className="flex items-center gap-2"> <span className="text-five">Submit</span>
